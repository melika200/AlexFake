...
function About(){
    ...
    return(
        <>
        <Container id="About" className="AboutState">
        <div className="AboutComponent">
        <h3 style={{fontSize:'38px'}} className="AboutHeader">About</h3>
                <p style={{fontSize:'16px',color:'#8d8d8e'}}>
            ...
            <Row className="AboutItems" style={{display:'flex',flexDirection:'row',marginTop:'13px'}}> 
             <Col >
             <img style={{width:'380px',height:'438px',borderRadius:'20%',marginLeft:'58px'}} src="https://static.vecteezy.com/system/resources/thumbnails/027/468/580/small_2x/a-software-developer-immersed-in-work-late-at-night-multiple-screens-casting-a-glow-on-his-focused-face-photo.jpeg" />
             </Col>
             <Col style={{display:'flex',flexDirection:'column',paddingLeft:'18px',marginLeft:'46px'}}>
             <h2>UI/UX Designer & Web Developer.</h2>
             <span style={{fontSize:'16px',color:'#8d8d8e',marginBottom:'15px'}} >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
             ...
             <span className="AboutItem"><b>Freelancer:</b>Available</span>
              ...
              <span  style={{fontSize:'17px',color:'#8d8d8e',marginTop:'26px'}}>Officiis eligendi itaque labore et dolorum mollitia officiis optio vero. 
        ...
        <Container className="AboutCountState">
            <Row style={{display:'flex',flexDirection:'row',justifyContent:'center',margin:'40px 0px'}}>
               {
                CountState.map((item)=>(
                    <Col style={{display:'flex',flexDirection:'column',margin:'0px 45px'}}>
                    <div style={{display:'flex',flexDirection:'row'}}>
                       <span style={{color:'#149ddd',fontSize:'49px',marginTop:'5px'}}>{item.icon}</span>
                        <span style={{fontSize:'50px',fontWeight:'bold',paddingLeft:'8px'}}>
