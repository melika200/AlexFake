...
function Skill(){
    ...
    return(
        <>
        <Container className="d-flex justify-content-center items-center SkillState flex-column m-auto" fluid style={{backgroundColor:'#f4fafd',marginBottom:'50px'}}>
            ...
            <Row style={{width:'65%'}} className="SkillProgress">
